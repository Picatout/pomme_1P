...
// This file is part of pomme-2
//
//     pomme-2 is free software: you can redistribute it and/or modify
//     it under the terms of the GNU General Public License as published by
//     the Free Software Foundation, either version 3 of the License, or
//     (at your option) any later version.
//
//     pomme-2 is distributed in the hope that it will be useful,
//     but WITHOUT ANY WARRANTY// without even the implied warranty of
//     MERCHANTABILITY or FITNESS FOR A PARTICULAR PURPOSE.  See the
//     GNU General Public License for more details.
//
//     You should have received a copy of the GNU General Public License
//     along with pomme-2.  If not, see <http://www.gnu.org/licenses/>.
////
//--------------------------------------
/*****************************************
    REGISTERS USAGE 
...
//-------------------------------
  _FUNC init_devices
// init clock to HSE 168 Mhz 
// set 3 wait states in FLASH_ACR_LATENCY
  _MOV32 R0,FLASH_BASE_ADR 
//  mov r2,#3
//  str r2,[r0,#FLASH_ACR]
/* configure clock for HSE, 24 Mhz crystal */
...
****************************************************/
  _MOV32 r1,((2<<27)+(2<<25)+(2<<21)+(56<<8)+(4<<4))
  str r1,[r0,#RCC_CFGR]
  /* enable PLL */
  ldr r1,[r0,#RCC_CR]
  orr r1, #1<<24 
...
wait_sws:
  ...
  tst r1,#(3<<2)
  beq wait_sws
/* now sysclock is 168 Mhz */
/* set boost mode in PWR_CR5 */
  _MOV32 r0,PWR_BASE_ADR
  ldr r1,[r0,#PWR_CR5]
  _MOV32 r2,0xfffffeff
  and r1,r1,r2 
  str r1,[r0,#PWR_CR5]
...
/* configure systicks for 1msec ticks */
  ...
  mov r1,#21000 /* reload value for 1msec */
  str r1,[r0,#STK_LOAD]
  mov r1,#3
  str r1,[r0,STK_CTL]
  _RET  
